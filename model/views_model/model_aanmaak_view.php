...
<div class="inlog_container">
    ...
    <form action="model_aanmaak.php" enctype="multipart/form-data" method="post" name="farm">
        ...
        <div class="login-box2">
            ...
            <input class="file_upload" type="file" multiple required name="fotonaam[]" accept="image/png, image/jpeg, image/gif">
            <br>
            <input type="checkbox" name="terms"> <label for="terms"></label>
            <input class="inlog_submit" type="submit" onclick="validateForm()">
